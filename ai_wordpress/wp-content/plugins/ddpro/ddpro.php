...
if (!class_exists('ddp_AM_License_Menu')) {
    ...
    ddp_AM_License_Menu::instance(__FILE__, 'Divi Den Pro Membership', '5.2.3', 'plugin', 'https://wp-den.com/');
}
...
//        For April 27
        ...
        if (strpos($post_content, 'grace_person_saturn')) {
        ...
        if($post) {
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-grace'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-grace') as $ddp_css_grace) {
                    ...
                    if ($ddp_css_grace == 'grace-persons-carina') {
                        wp_enqueue_script('ddp-grace-persons-carina-js', plugins_url('build/grace/js/persons/grace-persons-carina.js', __FILE__));
                    }
                    if ($ddp_css_grace == 'grace-persons-phoenix') {
                        wp_enqueue_script('ddp-grace-persons-phoenix-js', plugins_url('build/grace/js/persons/grace-persons-phoenix.js', __FILE__));
                    }
                    if ($ddp_css_grace == 'grace-persons-sirius') {
                        wp_enqueue_script('ddp-grace-persons-sirius-js', plugins_url('build/grace/js/persons/grace-persons-sirius.js', __FILE__));
                    }
